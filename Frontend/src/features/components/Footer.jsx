        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Create professional resumes in minutes. Stand out to employers with clean, structured, and modern templates designed for impact.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <Link to="/report" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
                  Report
                </Link>
              </li>
              <li>
                <Link to="/templates" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
                  Templates
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <Link to="/signup" className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
                  Sign Up
                </Link>
              </li>
            </ul>
